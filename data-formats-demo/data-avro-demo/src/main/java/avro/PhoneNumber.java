...
public class PhoneNumber extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public PhoneNumber(CharSequence number, Integer type) {
    this.number = number;
    this.type = type;
  }
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: number = (CharSequence)value$; break;
    case 1: type = (Integer)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   * @return A new PhoneNumber RecordBuilder
   */
  public static Builder newBuilder(PhoneNumber other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PhoneNumber>
     ...
     * @param other The existing instance to copy.
     */
    private Builder(PhoneNumber other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.number)) {
        this.number = data().deepCopy(fields()[0].schema(), other.number);
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setNumber(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setType(Integer value) {
    ...
    public PhoneNumber build() {
      try {
        ...
        record.number = fieldSetFlags()[0] ? this.number : (CharSequence) defaultValue(fields()[0]);
        record.type = fieldSetFlags()[1] ? this.type : (Integer) defaultValue(fields()[1]);
        return record;
