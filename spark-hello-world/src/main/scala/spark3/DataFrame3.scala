...
object DataFrame3 extends App {
  ...
  df7.toJSON.show(false)
  /*
  +------------------------------------------------------------+
  |value                                                       |
  +------------------------------------------------------------+
  |{"name":"Alice","age":27,"friend":{"name":"David","age":29}}|
  |{"name":"Bob","age":33,"friend":{"name":"George","age":39}} |
  |{"name":"Cathy","age":29,"friend":{"name":"John","age":30}} |
  +------------------------------------------------------------+
   */
  df8.toJSON.show(false)
  /*
  +------------------------------------------------------------------------------------------------------------------+
  |value                                                                                                             |
  +------------------------------------------------------------------------------------------------------------------+
  |{"name":"Alice","age":27,"friends":[{"name":"David","age":29},{"name":"Eva","age":19},{"name":"Fred","age":22}]}  |
  |{"name":"Bob","age":33,"friends":[{"name":"George","age":39},{"name":"Helen","age":22}]}                          |
  |{"name":"Cathy","age":29,"friends":[{"name":"John","age":30},{"name":"Katie","age":39},{"name":"Linda","age":20}]}|
  +------------------------------------------------------------------------------------------------------------------+
   */
  df9.toJSON.show(false)
  /*
  +--------------------------------------------------------------+
  |value                                                         |
  +--------------------------------------------------------------+
